...
// FutureBuilder<ProductM>(
//   future: Provider.of<ApiProvider>(context)
//       .getProductDetailsSlider(id),
//   builder: (context, snapshot) {
//     if (snapshot.hasData) {
//       ProductM product = snapshot.data;
//       if (product.data != null) {
//         String name = product.data.name ?? '';
//         String id = product.data.id ?? '125';
//         String permalink = product.data.permalink ?? '';
//         String price = product.data.price ?? '';
//         String regularPrice = product.data.regularPrice ?? '';
//         String salePrice = product.data.salePrice ?? '';
//         String description = product.data.description ?? '';
...
//             ? image = ''
//             : image = image;
//         String categoryName = product.data.category.isEmpty
//             ? 'سيتم تصنيفه قريبا'
//             : product.data.category.first.parent.name;
