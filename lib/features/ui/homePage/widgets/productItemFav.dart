...
class ProductItemFav extends StatelessWidget {
  ...
  ProductItemFav({@required this.imagePath
    , @required this.title, @required this.rating, @required this.prize, @required this.fav, this.product,this.index});
  getproduct(){
    return  ProductSql(
                          ...
                          child: GestureDetector(
                            onTap: () {
                              if(authProvider.isLogin){
                                ...
                                Provider.of<ApiProvider>(context, listen: false).remove(index);
                              }else{
